 ...
 */
final class LessThanOrEqualAssertionTest extends EvaluableAssertionTest
{
    ...
    {
        yield ['Expected "3" to be less than or equal to "2".', 3, 2];
        yield ['Expected "3" to be less than or equal to "2".', 3, '2'];
        yield ['Expected "3" to be less than or equal to "2".', '3', '2'];
        yield ['Expected "3.1" to be less than or equal to "3".', 3.1, 3];
    ...
    {
        yield ['Expected "2" to not be less than or equal to "3".', 2, 3];
        yield ['Expected "2" to not be less than or equal to "2".', 2, 2];
        yield ['Expected "2" to not be less than or equal to "3".', '2', 3];
        yield ['Expected "2" to not be less than or equal to "3".', '2', '3'];
        yield ['Expected "3" to not be less than or equal to "3.1".', 3, 3.1];
