 ...
 */
final class GreaterThanAssertionTest extends EvaluableAssertionTest
{
    ...
    {
        yield ['Expected "2" to be greater than "3".', 2, 3];
        yield ['Expected "3" to be greater than "3".', 3, 3];
        yield ['Expected "2" to be greater than "3".', '2', 3];
        yield ['Expected "2" to be greater than "3".', '2', '3'];
        yield ['Expected "3" to be greater than "3.1".', 3, 3.1];
    ...
    {
        yield ['Expected "3" to not be greater than "2".', 3, 2];
        yield ['Expected "3" to not be greater than "2".', 3, '2'];
        yield ['Expected "3" to not be greater than "2".', '3', '2'];
        yield ['Expected "3.1" to not be greater than "3".', 3.1, 3];
